...
class XLMEduNet(nn.Module):
    def __init__(self, modcols, contcols, padvals, extracols, 
        ...
        self.emb_content_id = nn.Embedding(13526, 128)
        self.emb_bundle_id = nn.Embedding(13526, 128)
        ...
        self.emb_cont_user_answer = nn.Embedding(13526 * 4, 128)
        ...
        IN_UNITSQ = \
                self.emb_content_id.embedding_dim + \
