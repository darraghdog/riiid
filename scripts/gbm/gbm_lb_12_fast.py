...
def add_user_feats(df, pdicts, update = True):
    ...
    #tagmin = np.zeros(len(df), dtype=np.float32)
    #tagmax = np.zeros(len(df), dtype=np.float32)
    #tagavg = np.zeros(len(df), dtype=np.float32)
    #tagcnt = np.zeros(len(df), dtype=np.uint32)
    ...
    for cnt,row in enumerate(df[itercols].values ):
        ...
        tstamp[cnt] = tstmp - pdicts['lag_time'][u] 
        ...
        if update:
            ...
            if yprev: 
                #for t in tags: pdicts['tag_answered_correctly_sum_u_dict'][f'{u}_{t}'] += 1
...
# Add new features to content df
# Feature fraction
# Add stats on tags
# Add bundle
# Keep the lectures in


dumpobj(f'weights/lgb/pdicts_{VERSION}_cut0_val.pk', pdicts)
dumpobj(f'data/valfull/cv1_{VERSION}_valid.pk', valid)
...
[100]	training's binary_logloss: 0.531379	valid_1's binary_logloss: 0.545446
[200]	training's binary_logloss: 0.529233	valid_1's binary_logloss: 0.543615
[300]	training's binary_logloss: 0.528167	valid_1's binary_logloss: 0.542914
[400]	training's binary_logloss: 0.527376	valid_1's binary_logloss: 0.542444
[500]	training's binary_logloss: 0.526792	valid_1's binary_logloss: 0.54215
[600]	training's binary_logloss: 0.526224	valid_1's binary_logloss: 0.541902
[700]	training's binary_logloss: 0.52573	valid_1's binary_logloss: 0.541706
[800]	training's binary_logloss: 0.525282	valid_1's binary_logloss: 0.541557
Early stopping, best iteration is:
[811]	training's binary_logloss: 0.525242	valid_1's binary_logloss: 0.541535
auc: 0.7746126211509885
'''
...
with tags
Training until validation scores don't improve for 20 rounds
[100]	training's binary_logloss: 0.531455	valid_1's binary_logloss: 0.545551
[200]	training's binary_logloss: 0.529357	valid_1's binary_logloss: 0.543749
[300]	training's binary_logloss: 0.52826	valid_1's binary_logloss: 0.542979
[400]	training's binary_logloss: 0.527529	valid_1's binary_logloss: 0.542545
[500]	training's binary_logloss: 0.526908	valid_1's binary_logloss: 0.542195
[600]	training's binary_logloss: 0.526343	valid_1's binary_logloss: 0.541909
[700]	training's binary_logloss: 0.525864	valid_1's binary_logloss: 0.541698
[800]	training's binary_logloss: 0.525385	valid_1's binary_logloss: 0.541493
[900]	training's binary_logloss: 0.524991	valid_1's binary_logloss: 0.541325
[1000]	training's binary_logloss: 0.524545	valid_1's binary_logloss: 0.541102
[1100]	training's binary_logloss: 0.524182	valid_1's binary_logloss: 0.540993
[1200]	training's binary_logloss: 0.523845	valid_1's binary_logloss: 0.540886
[1300]	training's binary_logloss: 0.523514	valid_1's binary_logloss: 0.540798
[1400]	training's binary_logloss: 0.523209	valid_1's binary_logloss: 0.540731
[1500]	training's binary_logloss: 0.522895	valid_1's binary_logloss: 0.540673
[1600]	training's binary_logloss: 0.522566	valid_1's binary_logloss: 0.54059
Early stopping, best iteration is:
[1627]	training's binary_logloss: 0.522475	valid_1's binary_logloss: 0.54057
auc: 0.7757160694671129
'''
